...
private val LightColors = lightColorScheme(
    ...
    surfaceContainerLow = Color(0xFFF8FFFC),
    surfaceContainer = Color(0xFFF6FFFB),
    surfaceContainerHigh = Color(0xFFF0FBF6),
    surfaceContainerHighest = Color(0xFFEAF7F1),
    surfaceDim = Color(0xFFE2F2EA),
